...
public class LineSegment {
    ...
    // emmm,首先，根本没让提交这个类，其次，提交也不能public
    // public boolean isSameLine(LineSegment that) {
    //     return that.p.slopeTo(this.p) == Double.NEGATIVE_INFINITY
    //             && that.q.slopeTo(this.q) == Double.NEGATIVE_INFINITY;
    // }
